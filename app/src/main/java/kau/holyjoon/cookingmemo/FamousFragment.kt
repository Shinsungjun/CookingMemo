...
class FamousFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        var mAdapter = IngreAdapter(context!!, ingredientList, resultList) {ingredient ->
            if(ingredient in resultList) {
        ...
        var mAdapter2 = IngreAdapter(context!!, ingredientList2,resultList){ingredient -> Toast.makeText(context,"${ingredient.name}",Toast.LENGTH_LONG).show()}
        var mAdapter3 = IngreAdapter(context!!, ingredientList3,resultList){ingredient -> Toast.makeText(context,"${ingredient.name}",Toast.LENGTH_LONG).show()}
        var mAdapter4 = IngreAdapter(context!!, ingredientList,resultList){ingredient -> Toast.makeText(context,"${ingredient.name}",Toast.LENGTH_LONG).show()}
        ...
        bt_total_2.setOnClickListener {
            if(mAdapter2.btSet == 0) {
                //mAdapter2 = IngreAdapter(context!!, ingredientList,resultList){ingredient -> Toast.makeText(context,"${ingredient.name}",Toast.LENGTH_LONG).show() }
                //famousRecyclerView2.adapter = mAdapter2
                mAdapter2.btSet = 1

            }
            else {
                //mAdapter2 = IngreAdapter(context!!, ingredientList2,resultList){ingredient -> Toast.makeText(context,"${ingredient.name}",Toast.LENGTH_LONG).show() }
                //famousRecyclerView2.adapter = mAdapter2
                mAdapter2.btSet = 0
            }
        ...
        bt_total_3.setOnClickListener {
            if(mAdapter3.btSet == 0) {
               // mAdapter3 = IngreAdapter(context!!, ingredientList,resultList){ingredient -> Toast.makeText(context,"${ingredient.name}",Toast.LENGTH_LONG).show() }
                //famousRecyclerView1.adapter = mAdapter3
                mAdapter3.btSet = 1

            }
            else {
               // mAdapter3 = IngreAdapter(context!!, ingredientList2,resultList){ingredient -> Toast.makeText(context,"${ingredient.name}",Toast.LENGTH_LONG).show() }
               // famousRecyclerView1.adapter = mAdapter3
                mAdapter3.btSet = 0
            }
        ...
        bt_total_4.setOnClickListener {
            if(mAdapter4.btSet == 0) {
               // mAdapter4 = IngreAdapter(context!!, ingredientList,resultList){ingredient -> Toast.makeText(context,"${ingredient.name}",Toast.LENGTH_LONG).show() }
               // famousRecyclerView1.adapter = mAdapter4
                mAdapter4.btSet = 1

            }
            else {
             //   mAdapter4 = IngreAdapter(context!!, ingredientList2,resultList){ingredient -> Toast.makeText(context,"${ingredient.name}",Toast.LENGTH_LONG).show() }
              //  famousRecyclerView1.adapter = mAdapter4
                mAdapter4.btSet = 0
            }
